...
import { ArrowLeft, ArrowRight, Upload, CheckCircle, Loader2, Bot, CreditCard, Bitcoin, DollarSign, Brain, Zap, Activity } from "lucide-react";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
        <Card className="w-full max-w-lg bg-slate-800/50 border-slate-700">
          <CardHeader className="text-center">
            ...
            <Badge className="mb-2 bg-blue-900/30 text-blue-400 border-blue-400/30">
              AI Agent #{orderId}
            </Badge>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-3">
              ...
              <Progress 
                value={orderStatus === 'completed' ? 100 : undefined} 
            ...
            <div className="space-y-4">
              {[
                { label: 'Deep Group Analysis', status: ['analyzing', 'verifying', 'transferring', 'completed'], icon: Brain },
            ...
            {orderStatus === 'completed' && (
              <Button onClick={onBack} className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700">
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
        <Card className="w-full max-w-lg bg-slate-800/50 border-slate-700">
          <CardHeader className="text-center">
            ...
            <Badge className="mb-2 bg-green-900/30 text-green-400 border-green-400/30">
              AI Mission Complete
            </Badge>
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex justify-between mb-4">
            <span className="text-sm text-slate-400">AI Step {getCurrentStepIndex() + 1} of {steps.length}</span>
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={step.id} className="flex flex-col items-center">
                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center mb-2 transition-all ${
        ...
        <Card className="mb-8 bg-slate-800/50 border-slate-700">
          ...
          <CardContent className="space-y-6">
            {currentStep === 'groups' && (
              <>
                <div className="space-y-3">
                  <Label htmlFor="sourceGroup" className="text-slate-300">Source Group URL</Label>
                  <Input
                    id="sourceGroup"
                  ...
                  <p className="text-sm text-slate-400">
                    🧠 AI will analyze member patterns and engagement metrics
                  </p>
                </div>
                
                <div className="space-y-3">
                  <Label htmlFor="targetGroup" className="text-slate-300">Target Group URL</Label>
                  <Input
                    id="targetGroup"
                  ...
                  />
                  <p className="text-sm text-slate-400">
                    🎯 Neural network will calculate compatibility scores
                  </p>
                </div>
                ...
                <div className="bg-blue-900/20 border border-blue-700/30 rounded-lg p-4">
                  ...
                  <p className="text-xs text-slate-400">
                    The neural network will perform deep analysis of both groups including member activity, 
                    engagement patterns, and optimal transfer timing before processing.
                  </p>
                </div>
              </>
            )}
            ...
            {currentStep === 'payment' && (
              <div className="space-y-4">
                ...
                <RadioGroup value={data.paymentMethod} onValueChange={(value) => setData({ ...data, paymentMethod: value })}>
            ...
            {currentStep === 'upload' && (
              <div className="space-y-6">
                <div>
                  <Label htmlFor="proof" className="text-slate-300">Payment Verification Data</Label>
                  <p className="text-sm text-slate-400 mb-3">
                    Provide transaction details for AI verification system
                  </p>
                  <Textarea
                    id="proof"
